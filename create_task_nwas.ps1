...
$ScriptPath = "C:\Users\Your Name\Desktop\NWAS-Data-Import\nwas_import.R" # script path
$WorkingDirectory = "C:\Users\Your Name\Desktop\NWAS-Data-Import" # The directory where your script is located
